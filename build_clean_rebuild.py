...
print("Pristine clean rebuild deployed!")
'''

with open("/home/admin/.gemini/antigravity/scratch/cloudflare-data-hub/clean_rebuild.py", "w", encoding="utf-8") as f:
    f.write(script)

print("Generated clean_rebuild.py!")
